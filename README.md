...
**Infrastructure:** Docker · Linux · nginx · systemd · Kubernetes · CI/CD · GCP · Oracle Cloud

**Networking:** TCP/IP · ICMP · ARP · BGP (FRRouting) · raw sockets

**Databases:** PostgreSQL · MongoDB · SQLite · MySQL

**AI / Retrieval:** RAG pipelines · FAISS · BM25 · sentence-transformers · LangChain · LangGraph · ChromaDB
